...
function Cart() {
  ...
  const checkOutHandler = (name) => {
    toast.success("Congratulations! Your "+name.toUpperCase()+" is Commig ", {
      position: "top-center",
    });
  };
  return (
      ...
      <div className="boxOfCart">
        ...
        {cartQuentity === 0 ? (
          ...
          <h1 className="empty-class">Cart is Empty</h1>
            ...
            <>
            <h4 style={{display:"flex",justifyContent:"center"}}>YOU HAVE {cartQuentity} FOOD ITEMS IN YOUR CART</h4>
