              ...
              <div className="card-container" key={i}>
                <div className="card">
                  <div className="card-body">
                    ...
                    <span className="card-author subtle">{value.category}<p> Quantity : <span style={{color :" white",fontSize:"25px"}}>{value.quantity}</span></p></span>
                  ...
                  <div>
                  <button className="btn btn-warning m-2" onClick={()=>increamentProducts(value.id)}>Increase</button>
                  <button className="btn btn-warning m-2" onClick={()=>decreamentProducts(value.id)}>Decreament</button>
                  <button className="btn btn-danger" onClick={()=>removeHandler(value.id )}>Remove</button>
                  </div>
